...
globalkeys = my_table.join(
    ...
    awful.key({ }, "XF86KbdBrightnessUp", function () awful.util.spawn_with_shell("sleep 0.5 && backlight.sh UP") end,
        {description = "keyboard backlight up", group = "hotkeys"}),
    awful.key({ }, "XF86KbdBrightnessDown", function () awful.util.spawn_with_shell("sleep 0.5 && backlight.sh DOWN") end,
        {description = "keyboard backlight down", group = "hotkeys"}),

    --awful.key({ }, "XF86KbdBrightnessUp", function () os.execute("notify-send 1") end,
    --    {description = "keyboard backlight up", group = "hotkeys"}),
    --awful.key({ }, "XF86KbdBrightnessDown", function () os.execute("backlight.sh DOWN") end,
    --    {description = "keyboard backlight down", group = "hotkeys"}),
